...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body class="fale_conosco buscas_salvas">
        <!--[if lt IE 7]>
                ...
                <div class="wrap">
                    ...
                    <article class="article col2">
                        ...
                        <h1 class="titleDefault">
                            Buscas <span class="verde">Salvas</span>
                        </h1>
                        
                        <h3 class="subtitleDefault">
                            <strong>Buscas Salvas</strong> é uma ferramenta que permite salvar a configuração dos filtros utilizados na busca que você fez. 
                            Assim, na próxima vez que você buscar um imóvel, poderá ir diretamente para a página de resultados sem precisar
                            selecionar novamente todos os filtros.
                        </h3>
                        ...
                        <div class="wrap_buscas row">
                            <ul class="lista_buscas_salvas">
                                <li>
                                    ...
                                    <div class="title">
                                        <strong>Nome cadastrado da busca</strong>
