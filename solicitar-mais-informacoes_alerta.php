...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body class="imoveis_favoritos">
        ...
        <div id="master">
            ...
            <div class="wrap_modalMensagem">

                <div class="wrap_modalMensagem_content box_cinza row">
                    
                    <h4 class="wrap_modalMensagem_title">
                        Mensagem enviada com sucesso!
                    </h4>

                    <p>
                        Obrigado por entrar em contato, retornaremos em breve. Continue navegando em nosso site.
                    </p>
                        
                    <a href="javascript:void(0);" class="wrap_modalMensagem_fechar btAzul004">ok</a>
                </div>
            </div>
                ...
                <div class="wrap">
                    ...
                    <article class="article col2">
                        ...
                        <h1 class="titleDefault">
                            Solicitar mais <span class="verde">informações</span>
                        </h1>
                                ...
                                <div class="box_form">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="floatLeft">
                                            ...
                                            <input name="tel_res_ddd" type="number" class="type_txt ddd">
                                            <input name="tel_res" type="number" class="type_txt tel">
                                        </div>
                                        <div class="floatLeft">
                                            <label for="tel_cel">
                                                Telefone Celular:
                                            </label>
                                            <input name="tel_cel_ddd" type="number" class="type_txt ddd">
                                            <input name="tel_cel" type="number" class="type_txt tel">
                                        </div>
